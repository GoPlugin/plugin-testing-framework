...
[![GitHub tag (latest by date)](https://img.shields.io/github/v/tag/goplugin/plugin-testing-framework)](https://github.com/goplugin/plugin-testing-framework/tags)
...
[![Go Version](https://img.shields.io/github/go-mod/go-version/goplugin/plugin-testing-framework)](https://go.dev/)
...
```sh
ENV_NAMESPACE="..."  go run k8s/examples/plugin/env.go
```
...
This repository contains helm charts used by the plugin organization mostly in QA.
...
```sh
helm repo add plugin-qa https://raw.githubusercontent.com/smartcontractkit/qa-charts/gh-pages/
helm search repo plugin
```
