	...
	tests := []struct {
	...
	}{
		{
			...
			setupFunc: func() {
				...
				os.Setenv("E2E_TEST_PLUGIN_IMAGE", "imageValue")
			...
			cleanupFunc: func() {
				...
				os.Unsetenv("E2E_TEST_PLUGIN_IMAGE")
			...
			expectedConfig: TestConfig{
				...
				PluginImage: &PluginImageConfig{Image: newString("imageValue")},
			},
		},
		{
			...
			setupFunc: func() {
				...
				os.Setenv("E2E_TEST_PLUGIN_IMAGE", "")
			},
			cleanupFunc: func() {
				os.Unsetenv("E2E_TEST_GROUP1_WALLET_KEY_1")
				os.Unsetenv("E2E_TEST_GROUP2_RPC_HTTP_URL_1")
