...
import (
	...
	"github.com/goplugin/plugin-testing-framework/lib/k8s/imports/k8s"
	"github.com/goplugin/plugin-testing-framework/lib/k8s/pkg"
	a "github.com/goplugin/plugin-testing-framework/lib/k8s/pkg/alias"
...
func (m *Environment) RunCustomReadyConditions(customCheck *client.ReadyCheckData, podCount int) error {
	...
	m.UpdateManifest()
	m.PluginNodeDetails = []*PluginNodeDetail{} // Resets potentially old details if re-deploying
	if m.Cfg.DryRun {
