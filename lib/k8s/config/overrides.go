...
const (
	...
	EnvVarDBURLExample     = "postgresql://postgres:node@localhost:5432/plugin_test?sslmode=disable"
	...
	EnvBase64ConfigOverriderDescription = "Base64-encoded TOML config (should contain at least plugin image and version)"
