...
// Plugin nodes have thrown during their test.
func WriteTeardownLogs(
	t *testing.T,
	env *environment.Environment,
	optionalTestReporter TestReporter,
	failingLogLevel zapcore.Level, // Plugin core uses zapcore for logging https://docs.chain.link/plugin-nodes/v1/configuration#log_level
	...
	if err := env.Artifacts.DumpTestResult(logsPath, "plugin"); err != nil {
...
var defaultAllowedLogMessages = []AllowedLogMessage{
	{
		...
		reason:  "Sometimes geth gets unlucky in the start up process and the Plugin node starts before geth is ready",
