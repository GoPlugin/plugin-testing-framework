...
const (
	/*
	 ...
	 Core Chart: https://github.com/goplugin/infra-charts/tree/main/plugin-cluster
	*/
...
// CoreDONConnectionConfig Plugin DON connection config
...
func ReadCRIBVars() (*ConnectionVars, error) {
	...
	if nodes < 2 {
		return nil, fmt.Errorf("not enough plugin nodes, need at least 2")
	}
