...
// EstimateCostForPluginOperations calculates required amount of ETH for amountOfOperations Plugin operations
// based on the network's suggested gas price and the plugin gas limit. This is fairly imperfect and should be used
...
func (e *EthereumClient) EstimateCostForPluginOperations(amountOfOperations int) (*big.Float, error) {
	...
	// total gas limit = plugin gas limit + gas limit buffer
	gasLimit := e.NetworkConfig.GasEstimationBuffer + e.NetworkConfig.PluginTransactionLimit
...
func (e *EthereumMultinodeClient) EstimateCostForPluginOperations(amountOfOperations int) (*big.Float, error) {
	return e.DefaultClient.EstimateCostForPluginOperations(amountOfOperations)
}
